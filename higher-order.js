...
//Code Here
let totalPopulation = populations.reduce((arr,curr)=>arr+curr);
...
//Code Here
let myStrongest = monstersInYourPocket.filter((arr,curr)=>arr.CP>200
)
// console.log(myStrongest.length)
...
let bobsTotal = purchases.reduce((a,c)=>{
  let sum = c.owner === "Bob" ? a+c.price : a+0;
  return sum
},0)
